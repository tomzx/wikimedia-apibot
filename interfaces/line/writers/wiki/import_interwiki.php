...
#  Line framework - Import page interwiki Writer class
#
...
class Writer_Wiki_ImportInterwiki extends Writer_Wiki_Generic
{

	public $summary        = NULL;

	public $iwcode         = NULL;
	public $fullhistory    = NULL;
	public $into_namespace = NULL;
