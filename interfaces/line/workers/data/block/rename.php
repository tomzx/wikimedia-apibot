...
#  Line framework - Signal data block key worker class
#
...
class Worker_DataBlock_Rename extends Worker_DataBlock
{
	...
	protected function process_data ( &$signal )
	{
		...
		$signal->rename_data_block ( $this->default_data_key, $this->new_key );
