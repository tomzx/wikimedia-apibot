...
#  Line framework - Signal custom data element setter class - String - Length
#
...
class Worker_DataElement_String_Length extends Worker_DataElement_String
{
	...
	protected function modify_element ( $element )
	{
		if ( $this->mb )
			if ( isset ( $this->encoding ) )
				return mb_strlen ( $element, $this->encoding );
			else
