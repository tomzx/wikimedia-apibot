...
#  Line framework - Edit page - Delete wikilinks Worker class.
#
...
class Worker_EditPage_DeleteWikilinks extends Worker_EditPage
{
	...
	{
		return parent::signal_log_slot_name() . ".Delete.Wikilinks";
	}
	...
	protected function make_edits ( &$data_block )
	{
		...
		if ( isset ( $this->tasks['name'] ) )
			...
			$count = $data_block['*']->delete_wikilink (
		...
		$this->add_changes ( '$1 wikilinks deleted', $count );
