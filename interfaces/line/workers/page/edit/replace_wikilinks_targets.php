...
#  Line framework - Edit page - Replace wikilinks targets Worker class.
#
...
class Worker_EditPage_ReplaceWikilinksTargets extends Worker_EditPage_Replace
{
	...
	{
		return parent::signal_log_slot_name() . ".Wikilinks.Targets";
	}
	...
	protected function perform_replace ( &$page, $task )
	{
		...
		return $page->replace_wikilink_target (
			( isset ( $task['colon'] )
				? $task['colon']
				: NULL ),
			( isset ( $task['wiki'] )
