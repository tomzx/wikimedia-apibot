...
#  Line framework - Edit page - Replace wikilinks texts Worker class.
#
...
class Worker_EditPage_ReplaceWikilinksTexts extends Worker_EditPage_Replace
{
	...
	{
		return parent::signal_log_slot_name() . ".Wikilinks.Texts";
	}
	...
	protected function perform_replace ( &$page, $task )
	{
		...
		return $page->replace_wikilink_text (
			( isset ( $task['colon'] )
				? $task['colon']
				: NULL ),
			( isset ( $task['wiki'] )
