...
class Worker_SetParam_Counter extends Worker_SetParam_Misc
{
	...
	{
		$this->from_group = NULL;  // or parent::new_paramvalue() might scream and die
		$this->from_name  = NULL;

		$result = parent::new_paramvalue ( $signal );
		if ( is_null ( $result ) )
			return NULL;
