...
#  Line: Worker: Param: Set: Strings: Pad class
#
...
class Worker_SetParam_String_Pad extends Worker_SetParam_String
{
	...
	protected function modify_paramvalue ( $from_value )
	{
		...
		return str_pad ( $from_value, $this->length, $this->with, $this->type );
	}
