...
#  Line framework - Alllinks Generator feeder class
#
...
class Feeder_Query_Generator_Alllinks extends Feeder_Query_Generator
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Alllinks ( $core );
	}
