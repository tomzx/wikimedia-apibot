...
#  Line framework - Querypage Generator feeder class
#
...
class Feeder_Query_Generator_Querypage extends
	Feeder_Query_Generator_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Querypage ( $this->pagename, $this->core );
	}
