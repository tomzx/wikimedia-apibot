...
#  Line framework - Categorymembers Generator feeder class
#
...
class Feeder_Query_Generator_Categorymembers extends Feeder_Query_Generator
{


	public $set_category_from_signal_data = true;
	...
	{
		if ( ( $this->set_category_from_signal_data ) &&
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Categorymembers ( $core );
	}
