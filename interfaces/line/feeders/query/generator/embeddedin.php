...
#  Line framework - Embeddedin Generator feeder class
#
...
class Feeder_Query_Generator_Embeddedin extends Feeder_Query_Generator
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Embeddedin ( $core );
	}
