...
#  Line framework - Mostlinked Querypage Generator feeder class
#
...
class Feeder_Query_Generator_Querypage_Mostlinked extends
	Feeder_Query_Generator_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Querypage_Mostlinked ( $core );
	}
