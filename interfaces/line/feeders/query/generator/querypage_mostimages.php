...
#  Line framework - Mostimages Querypage Generator feeder class
#
...
class Feeder_Query_Generator_Querypage_Mostimages extends
	Feeder_Query_Generator_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Querypage_Mostimages ( $core );
	}
