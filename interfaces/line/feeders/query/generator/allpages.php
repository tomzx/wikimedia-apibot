...
#  Line framework - Allpages Generator feeder class
#
...
class Feeder_Query_Generator_Allpages extends Feeder_Query_Generator
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Allpages ( $core );
	}
