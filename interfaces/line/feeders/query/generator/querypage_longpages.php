...
#  Line framework - Longpages Querypage Generator feeder class
#
...
class Feeder_Query_Generator_Querypage_Longpages extends
	Feeder_Query_Generator_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_Generator_Querypage_Longpages ( $core );
	}
