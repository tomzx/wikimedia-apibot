...
#  Line framework - Categorymembers List feeder class
#
...
class Feeder_Query_List_Categorymembers extends Feeder_Query_List
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_List_Categorymembers ( $core );
	}
