...
#  Line framework - Unusedimages Querypage List feeder class
#
...
class Feeder_Query_List_Querypage_Unusedimages extends
	Feeder_Query_List_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_List_Querypage_Unusedimages ( $core );
	}
