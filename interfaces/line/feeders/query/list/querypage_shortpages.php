...
#  Line framework - Shortpages Querypage List feeder class
#
...
class Feeder_Query_List_Querypage_Shortpages extends
	Feeder_Query_List_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_List_Querypage_Shortpages ( $core );
	}
