...
#  Line framework - Blanket include for all list query feeder modules.
#
...
require_once ( dirname ( __FILE__ ) . '/allusers.php' );
...
require_once ( dirname ( __FILE__ ) . '/deletedrevs.php' );
require_once ( dirname ( __FILE__ ) . '/embeddedin.php' );
require_once ( dirname ( __FILE__ ) . '/exturlusage.php' );
require_once ( dirname ( __FILE__ ) . '/filearchive.php' );
...
require_once ( dirname ( __FILE__ ) . '/usercontribs.php' );
