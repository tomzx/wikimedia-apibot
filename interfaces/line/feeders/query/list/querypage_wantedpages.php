...
#  Line framework - Wantedpages Querypage List feeder class
#
...
class Feeder_Query_List_Querypage_Wantedpages extends
	Feeder_Query_List_QuerypageGeneric
{
	...
	protected function query ( &$core )
	{
		...
		return new Query_List_Querypage_Wantedpages ( $core );
	}
