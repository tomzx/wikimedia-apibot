...
class Feeder_Info_User_Acceptlang extends Feeder_Info_User
{
	...
	{
		return "array/useracceptlang";
	}

	protected function signal_log_slot_name ()
	{
		return parent::signal_log_slot_name() . ".Acceptlang";
	}


	protected function info_elements_array()
	{
		return $this->core->info->user_acceptlang();
	}
