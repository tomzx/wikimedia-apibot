...
#  Line framework - Regexes (all) don't match General title filter class
#
...
class Filter_General_Title_RegexesNotExist_All extends
	Filter_General_Title_CheckRegexesExistence
{
