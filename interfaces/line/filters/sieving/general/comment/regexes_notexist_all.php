...
#  Line framework - Regexes don't exist (all) in wiki object comment filter class
#
...
class Filter_General_Comment_RegexesNotExist_All extends
	Filter_General_Comment_CheckRegexesExistence
{
