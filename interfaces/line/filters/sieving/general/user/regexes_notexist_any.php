...
#  Line framework - Regexes (any) don't match user name filter class
#
...
class Filter_General_User_RegexesNotExist_Any extends
	Filter_General_User_CheckRegexesExistence
{
