...
#  Line framework - User names generic filter class
#
...
abstract class Filter_User_Name extends Filter_User
{
	...
	{
		return parent::slotname_preface() . ".Name";
	}
