...
#  Line framework - Regexes (any) don't match User specified property filter class
#
...
class Filter_User_SpecifiedProperty_RegexesNotExist_Any extends
	Filter_User_SpecifiedProperty_CheckRegexesExistence
{
