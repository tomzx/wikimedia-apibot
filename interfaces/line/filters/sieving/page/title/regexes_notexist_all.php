...
#  Line framework - Regexes (all) don't match page title filter class
#
...
class Filter_Page_Title_RegexesNotExist_All extends
	Filter_Page_Title_CheckRegexesExistence
{
