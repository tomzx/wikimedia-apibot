...
#  Line framework - Interwikis exist in pages text generic filter class
#
...
abstract class Filter_Page_Text_CheckInterwikisExistence extends
	Filter_Page_Text
{
	...
	public function interwiki_exists ( $page, $interwiki )
	{
		return $page->interwiki_exists ( $interwiki );
	}
