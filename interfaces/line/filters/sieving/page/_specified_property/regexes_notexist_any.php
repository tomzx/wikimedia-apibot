...
#  Line framework - Regexes (any) don't match Page specified property filter class
#
...
class Filter_Page_SpecifiedProperty_RegexesNotExist_Any extends
	Filter_Page_SpecifiedProperty_CheckRegexesExistence
{
