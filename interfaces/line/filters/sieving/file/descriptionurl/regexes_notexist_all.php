...
#  Line framework - Regexes don't exist (all) in File DescriptionUrl filter class
#
...
class Filter_File_DescriptionUrl_RegexesNotExist_All extends
	Filter_File_DescriptionUrl_CheckRegexesExistence
{
