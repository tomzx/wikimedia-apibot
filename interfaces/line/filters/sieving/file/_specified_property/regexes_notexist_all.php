...
#  Line framework - Regexes (all) don't match File specified property filter class
#
...
class Filter_File_SpecifiedProperty_RegexesNotExist_All extends
	Filter_File_SpecifiedProperty_CheckRegexesExistence
{
