...
#  Line: Filters: Sort passing data: By the entire data element.
#
...
class Filter_Sort_ByDataElement extends Filter_Sort
{
	...
	{
		$data = $signal->data_block ( $this->default_data_key );
		if ( is_array ( $data ) )
			return $data['*'];
		else
			return NULL;
