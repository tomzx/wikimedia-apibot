...
class API_Action_Userrights extends API_Action
{
	...
	public function nohooks__set_params ( $hook_object, $params )
	{
		...
		$this->set_token ( $params,
			$this->backend->tokens->userrights_token ( $params['user'] ),
			$params['user'] );
	...
	{
		return new API_Module_Userrights ( $this->backend->exchanger,
