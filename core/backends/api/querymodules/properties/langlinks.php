...
#  API: Querymodules: Properties: Langlinks (interwikis).
#
...
class API_Params_Property_Langlinks extends API_Params_Property
{
	...
	protected function hardcoded_paramdesc ( $mwverno )
	{
		...
		if ( $mwverno >= 12300 )  // some might be earlier - didn't checked that properly
		{
			...
			$paramdesc['params']['inlanguagecode'] = array (
