...
#  API: Query: Generator: Module by paraminfo.
#
...
class API_Query_Generator_ByName extends API_Query_Generator
{
	...
	{
		if ( $this->backend->info->is_available_generator ( $this->modulename ) )
