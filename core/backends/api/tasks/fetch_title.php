...
class API_Task_FetchTitle extends API_Task_GenericFetchEditablePage
{
	...
	public function nohooks__go ( $hook_object, $params )
	{
		...
		$logbeg = "Page [[" . $title . "]]";
		if ( isset ( $params['revid'] ) && ! is_null ( $params['revid'] ) )
			$logbeg .= ", revid " . $params['revid'];
