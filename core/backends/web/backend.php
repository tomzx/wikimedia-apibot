...
class Backend_Web extends Backend
{
	...
	{
		return new Exchanger_Web ( $url, $settings, $defaults, $log, $browser,
			$hooks );
	}
	...
	{
		return new Identity_Web ( $exchanger, $infostore, $hooks, $settings,
			$backend_name );
	}
	...
	{
		return new Info_Web ( $exchanger, $infostore, $identity, $hooks, $settings );
	}
	...
	{
		return new Tokens_Web ( $exchanger, $info, $hooks, $settings );
	}
