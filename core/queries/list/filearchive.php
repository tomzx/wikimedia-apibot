...
#  Backend-independent Query: List: Filearchive.
#
...
class Query_List_Filearchive extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/filearchive.php' );
		return new API_Query_List_Filearchive (
