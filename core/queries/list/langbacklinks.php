...
#  Backend-independent Query: List: Langbacklinks.
#
...
class Query_List_Langbacklinks extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/langbacklinks.php' );
		return new API_Query_List_Langbacklinks (
