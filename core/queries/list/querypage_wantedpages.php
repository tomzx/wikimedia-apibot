...
class Query_List_Querypage_Wantedpages extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/querypage_wantedpages.php' );
		return new API_Query_List_Querypage_Wantedpages (
