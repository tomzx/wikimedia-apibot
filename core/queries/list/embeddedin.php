...
#  Backend-independent Query: List: Embeddedin.
#
...
class Query_List_Embeddedin extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/embeddedin.php' );
		return new API_Query_List_Embeddedin (
