...
#  Backend-independent Query: List: Allpages.
#
...
class Query_List_Allpages extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/allpages.php' );
		return new API_Query_List_Allpages (
