...
#  Backend-independent Query: List: Watchlist.
#
...
class Query_List_Watchlist extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/watchlist.php' );
		return new API_Query_List_Watchlist (
