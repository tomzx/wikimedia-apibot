...
#  Backend-independent Query: List: Protectedtitles.
#
...
class Query_List_Protectedtitles extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/protectedtitles.php' );
		return new API_Query_List_Protectedtitles (
