...
#  Backend-independent Query: List: Exturlusage.
#
...
class Query_List_Exturlusage extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/exturlusage.php' );
		return new API_Query_List_Exturlusage (
