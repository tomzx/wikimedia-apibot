...
#  Backend-independent Query: List: Imageusage.
#
...
class Query_List_Imageusage extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/imageusage.php' );
		return new API_Query_List_Imageusage (
