...
#  Backend-independent Query: List: Alllinks.
#
...
class Query_List_Alllinks extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/alllinks.php' );
		return new API_Query_List_Alllinks (
