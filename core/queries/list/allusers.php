...
#  Backend-independent Query: List: Allusers.
#
...
class Query_List_Allusers extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/allusers.php' );
		return new API_Query_List_Allusers (
