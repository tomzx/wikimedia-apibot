...
#  Backend-independent Query: List: Querypage.
#
...
class Query_List_Querypage extends Query_List
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/list/querypage.php' );
		return new API_Query_List_Querypage ( $this->pagename,
