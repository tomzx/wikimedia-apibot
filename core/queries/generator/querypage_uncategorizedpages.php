...
class Query_Generator_Querypage_Uncategorizedpages extends Query_Generator
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/generator/querypage_uncategorizedpages.php' );
		return new API_Query_Generator_Querypage_Uncategorizedpages (
