...
#  Backend-independent Query: Property: Categories.
#
...
class Query_Property_Categories extends Query_Property
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/property/categories.php' );
		return new API_Query_Property_Categories (
