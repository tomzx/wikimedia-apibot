...
#  Backend-independent Query: Property: Duplicatefiles.
#
...
class Query_Property_Duplicatefiles extends Query_Property
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/property/duplicatefiles.php' );
		return new API_Query_Property_Duplicatefiles (
