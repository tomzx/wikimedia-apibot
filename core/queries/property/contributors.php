...
#  Backend-independent Query: Property: Contributors.
#
...
class Query_Property_Contributors extends Query_Property
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/property/contributors.php' );
		return new API_Query_Property_Contributors (
