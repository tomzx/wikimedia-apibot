...
#  Backend-independent Query: Property: Images.
#
...
class Query_Property_Images extends Query_Property
{
	...
	protected function api_query ()
	{
		require_once ( dirname ( __FILE__ ) .
			'/../../backends/api/queries/property/images.php' );
		return new API_Query_Property_Images (
